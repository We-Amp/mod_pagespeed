...
pagespeed.CriticalCssBeacon.prototype.sendBeacon_ = function() {
  ...
  a += "&cs=";
  for (var b = 0; b < this.criticalSelectors_.length; ++b) {
    var c = b > 0 ? "," : "";
    c += encodeURIComponent(this.criticalSelectors_[b]);
...
pagespeed.CriticalCssBeacon.prototype.checkCssSelectors_ = function(a) {
  for (var b = 0; b < this.MAXITERS_ && this.idx_ < this.selectors_.length; ++b, ++this.idx_) {
    try {
      document.querySelector(this.selectors_[this.idx_]) != null && this.criticalSelectors_.push(this.selectors_[this.idx_]);
    } catch (c) {
    }
  }
