...
TEST_F(JsDisableFilterTest, DisablesScript) {
  ...
  const GoogleString expected = StrCat(
      ...
      StrCat(
          ...
          "onload=\"",
          JsDisableFilter::kElementOnloadCode,
          "\">"
...
TEST_F(JsDisableFilterTest, DisablesScriptWithExperimental) {
  ...
  const GoogleString input_html = StrCat(
      "<body>", kUnrelatedNoscriptTags,
      "<script src=\"blah1\" random=\"true\">hi1</script>", kUnrelatedTags,
      "<script src=\"blah2\" random=\"false\">hi2</script>", "</body>");
  const GoogleString expected =
      StrCat("<body>", kUnrelatedNoscriptTags,
             "<script src=\"blah1\" random=\"true\" type=\"text/psajs\""
             " data-pagespeed-orig-index=\"0\">hi1</script>",
             ...
             JsDisableFilter::kEnableJsExperimental, "</script></body>");
...
TEST_F(JsDisableFilterTest, DisablesScriptWithUnescapedQueryParam) {
  const GoogleString input_html = StrCat(
      kUnrelatedNoscriptTags,
      "<script src=\"x?a=b&c=d\" random=\"true\">hi1</script>", kUnrelatedTags,
      "<script src=\"y?a=b&c=d\" random=\"false\">hi2</script>");
  const GoogleString expected = StrCat(
      kUnrelatedNoscriptTags,
      "<script src=\"x?a=b&c=d\" random=\"true\""
...
TEST_F(JsDisableFilterTest, DisablesScriptWithNullSrc) {
  const GoogleString input_html =
      StrCat(kUnrelatedNoscriptTags, "<script src random=\"true\">hi1</script>",
             kUnrelatedTags, "<script src random=\"false\">hi2</script>");
  const GoogleString expected =
      StrCat(kUnrelatedNoscriptTags,
...
TEST_F(JsDisableFilterTest, DisablesScriptOnlyFromFirstSrc) {
  ...
  const GoogleString expected = StrCat(
      "<body>", absl::StrFormat(kNoScriptRedirectFormatter, kUrl, kUrl),
      kUnrelatedNoscriptTags,
...
TEST_F(JsDisableFilterTest, AddsMetaTagForIE) {
  ...
  const GoogleString input_html =
      StrCat("<body>", kUnrelatedNoscriptTags,
             ...
             kUnrelatedTags, "</body>");
  const GoogleString expected =
      StrCat(StrCat("<head>", kXUACompatibleMetaTag,
                    "</head>"
                    "<body>"),
             StrCat(kUnrelatedNoscriptTags,
                    "<script src=\"blah1\" random=\"true\" type=\"text/psajs\""
...
TEST_F(JsDisableFilterTest, ScriptWithPagespeedPrioritizeAttribute) {
  ...
  const GoogleString expected = StrCat(
      ...
      " data-pagespeed-orig-index=\"0\">hi1</script>",
      kUnrelatedTags,
      StrCat("<img src=\"abc.jpg\" data-pagespeed-onload=\"foo1();foo2();\" "
             "onload=\"",
             JsDisableFilter::kElementOnloadCode,
             "\">"
