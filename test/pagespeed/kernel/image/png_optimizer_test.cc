...
void PopulateDescriptor(const GoogleString& img, ReadPngDescriptor* desc,
  ...
  switch (scanline_reader.GetPixelFormat()) {
    ...
    case pagespeed::image_compression::GRAY_8:
      ...
      break;
    default:
      PS_LOG_INFO((&message_handler), "Unexpected pixel format: %d",
  ...
  desc->img_bytes =
      static_cast<unsigned char*>(malloc(desc->row_bytes * desc->height));
  if (channels == 4) {
    desc->img_rgba_bytes = desc->img_bytes;
  } else {
    desc->img_rgba_bytes =
        static_cast<unsigned char*>(malloc(4 * desc->width * desc->height));
  }
  ...
  if (channels != 4) {
    ...
    for (unsigned long pixel_count = 0;  // NOLINT
         pixel_count < desc->height * desc->width; ++pixel_count) {
      if (channels == 3) {
...
void AssertPngEq(const GoogleString& orig, const GoogleString& opt,
                 const char* identifier, const GoogleString& in_rgba) {
...
void AssertReadersMatch(ScanlineReaderInterface* reader1,
  ...
  while (reader1->HasMoreScanLines() && reader2->HasMoreScanLines()) {
    ASSERT_TRUE(reader1->ReadNextScanline(reinterpret_cast<void**>(&pixels1)));

    ASSERT_TRUE(reader2->ReadNextScanline(reinterpret_cast<void**>(&pixels2)));
...
ImageCompressionInfo kValidImages[] = {
    ...
    ImageCompressionInfo("basi0g04", 247, 145, 257, 32, 32, 4, 0, 4, 0),
    ImageCompressionInfo("basi0g08", 254, 250, 799, 32, 32, 8, 0, 8, 0),
    ImageCompressionInfo("basi0g16", 299, 285, 1185, 32, 32, 16, 0, 16, 0),
    ImageCompressionInfo("basi2c08", 315, 313, 1489, 32, 32, 8, 2, 8, 2),
    ImageCompressionInfo("basi2c16", 595, 557, 2834, 32, 32, 16, 2, 16, 2),
    ImageCompressionInfo("basi3p01", 132, 132, 135, 32, 32, 1, 3, 1, 3),
    ImageCompressionInfo("basi3p02", 193, 178, 182, 32, 32, 2, 3, 2, 3),
    ImageCompressionInfo("basi3p04", 327, 312, 325, 32, 32, 4, 3, 4, 3),
    ImageCompressionInfo("basi3p08", 1527, 1518, 1830, 32, 32, 8, 3, 8, 3),
    ImageCompressionInfo("basi4a08", 214, 209, 1439, 32, 32, 8, 4, 8, 4),
    ImageCompressionInfo("basi4a16", 2855, 1980, 1996, 32, 32, 16, 4, 16, 4),
    ImageCompressionInfo("basi6a08", 361, 350, 2612, 32, 32, 8, 6, 8, 6),
    ImageCompressionInfo("basi6a16", 4180, 4133, 4444, 32, 32, 16, 6, 16, 6),
    ImageCompressionInfo("basn0g01", 164, 164, 163, 32, 32, 1, 0, 1, 0),
    ImageCompressionInfo("basn0g02", 104, 104, 106, 32, 32, 2, 0, 2, 0),
    ImageCompressionInfo("basn0g04", 145, 103, 149, 32, 32, 4, 0, 4, 0),
    ImageCompressionInfo("basn0g08", 138, 132, 730, 32, 32, 8, 0, 8, 0),
    ImageCompressionInfo("basn0g16", 167, 152, 645, 32, 32, 16, 0, 16, 0),
    ImageCompressionInfo("basn2c08", 145, 145, 1428, 32, 32, 8, 2, 8, 2),
    ImageCompressionInfo("basn2c16", 302, 274, 2666, 32, 32, 16, 2, 16, 2),
    ImageCompressionInfo("basn3p01", 112, 112, 115, 32, 32, 1, 3, 1, 3),
    ImageCompressionInfo("basn3p02", 146, 131, 132, 32, 32, 2, 3, 2, 3),
    ImageCompressionInfo("basn3p04", 216, 201, 206, 32, 32, 4, 3, 4, 3),
    ImageCompressionInfo("basn3p08", 1286, 1286, 1920, 32, 32, 8, 3, 8, 3),
    ImageCompressionInfo("basn4a08", 126, 121, 1422, 32, 32, 8, 4, 8, 4),
    ImageCompressionInfo("basn4a16", 2206, 1185, 1194, 32, 32, 16, 4, 16, 4),
    ImageCompressionInfo("basn6a08", 184, 176, 2579, 32, 32, 8, 6, 8, 6),
    ImageCompressionInfo("basn6a16", 3435, 3271, 4338, 32, 32, 16, 6, 16, 6),
    ImageCompressionInfo("bgai4a08", 214, 209, 1439, 32, 32, 8, 4, 8, 4),
    ImageCompressionInfo("bgai4a16", 2855, 1980, 1996, 32, 32, 16, 4, 16, 4),
    ImageCompressionInfo("bgan6a08", 184, 176, 2579, 32, 32, 8, 6, 8, 6),
    ImageCompressionInfo("bgan6a16", 3435, 3271, 4338, 32, 32, 16, 6, 16, 6),
    ImageCompressionInfo("bgbn4a08", 140, 121, 1422, 32, 32, 8, 4, 8, 4),
    ImageCompressionInfo("bggn4a16", 2220, 1185, 1194, 32, 32, 16, 4, 16, 4),
    ImageCompressionInfo("bgwn6a08", 202, 176, 2579, 32, 32, 8, 6, 8, 6),
    ImageCompressionInfo("bgyn6a16", 3453, 3271, 4338, 32, 32, 16, 6, 16, 6),
    ImageCompressionInfo("ccwn2c08", 1514, 1456, 1734, 32, 32, 8, 2, 8, 2),
    ImageCompressionInfo("ccwn3p08", 1554, 1499, 1521, 32, 32, 8, 3, 8, 3),
    ImageCompressionInfo("cdfn2c08", 404, 498, 531, 8, 32, 8, 2, 8, 3),
    ImageCompressionInfo("cdhn2c08", 344, 476, 489, 32, 8, 8, 2, 8, 3),
    ImageCompressionInfo("cdsn2c08", 232, 255, 257, 8, 8, 8, 2, 8, 3),
    ImageCompressionInfo("cdun2c08", 724, 928, 964, 32, 32, 8, 2, 8, 3),
    ImageCompressionInfo("ch1n3p04", 258, 201, 206, 32, 32, 4, 3, 4, 3),
    ImageCompressionInfo("ch2n3p08", 1810, 1286, 1920, 32, 32, 8, 3, 8, 3),
    ImageCompressionInfo("cm0n0g04", 292, 271, 277, 32, 32, 4, 0, 4, 0),
    ImageCompressionInfo("cm7n0g04", 292, 271, 277, 32, 32, 4, 0, 4, 0),
    ImageCompressionInfo("cm9n0g04", 292, 271, 277, 32, 32, 4, 0, 4, 0),
    ImageCompressionInfo("cs3n2c16", 214, 178, 228, 32, 32, 16, 2, 16, 2),
    ...
    ImageCompressionInfo("ct0n0g04", 273, 271, 277, 32, 32, 4, 0, 4, 0),
    ImageCompressionInfo("ct1n0g04", 792, 271, 277, 32, 32, 4, 0, 4, 0),
    ImageCompressionInfo("ctzn0g04", 753, 271, 277, 32, 32, 4, 0, 4, 0),
    ImageCompressionInfo("f00n0g08", 319, 312, 315, 32, 32, 8, 0, 8, 0),
    ImageCompressionInfo("f00n2c08", 2475, 1070, 2458, 32, 32, 8, 2, 8, 2),
    ImageCompressionInfo("f01n0g08", 321, 246, 282, 32, 32, 8, 0, 8, 0),
    ImageCompressionInfo("f01n2c08", 1180, 965, 2535, 32, 32, 8, 2, 8, 2),
    ImageCompressionInfo("f02n0g08", 355, 289, 296, 32, 32, 8, 0, 8, 0),
    ImageCompressionInfo("f02n2c08", 1729, 1024, 2497, 32, 32, 8, 2, 8, 2),
    ImageCompressionInfo("f03n0g08", 389, 292, 294, 32, 32, 8, 0, 8, 0),
    ImageCompressionInfo("f03n2c08", 1291, 1062, 2492, 32, 32, 8, 2, 8, 2),
    ImageCompressionInfo("f04n0g08", 269, 273, 284, 32, 32, 8, 0, 8, 0),
    ImageCompressionInfo("f04n2c08", 985, 985, 2533, 32, 32, 8, 2, 8, 2),
    ImageCompressionInfo("g03n0g16", 345, 273, 302, 32, 32, 16, 0, 8, 0),
    ImageCompressionInfo("g03n2c08", 370, 396, 493, 32, 32, 8, 2, 8, 3),
    ImageCompressionInfo("g03n3p04", 214, 214, 225, 32, 32, 4, 3, 4, 3),
    ImageCompressionInfo("g04n0g16", 363, 287, 306, 32, 32, 16, 0, 8, 0),
    ImageCompressionInfo("g04n2c08", 377, 399, 497, 32, 32, 8, 2, 8, 3),
    ImageCompressionInfo("g04n3p04", 219, 219, 230, 32, 32, 4, 3, 4, 3),
    ImageCompressionInfo("g05n0g16", 339, 275, 302, 32, 32, 16, 0, 8, 0),
    ImageCompressionInfo("g05n2c08", 350, 402, 492, 32, 32, 8, 2, 8, 3),
    ImageCompressionInfo("g05n3p04", 206, 206, 217, 32, 32, 4, 3, 4, 3),
    ImageCompressionInfo("g07n0g16", 321, 261, 302, 32, 32, 16, 0, 8, 0),
    ImageCompressionInfo("g07n2c08", 340, 401, 491, 32, 32, 8, 2, 8, 3),
    ImageCompressionInfo("g07n3p04", 207, 207, 218, 32, 32, 4, 3, 4, 3),
    ImageCompressionInfo("g10n0g16", 262, 210, 303, 32, 32, 16, 0, 8, 0),
    ImageCompressionInfo("g10n2c08", 285, 403, 497, 32, 32, 8, 2, 8, 3),
    ImageCompressionInfo("g10n3p04", 214, 214, 222, 32, 32, 4, 3, 4, 3),
    ImageCompressionInfo("g25n0g16", 383, 305, 304, 32, 32, 16, 0, 8, 0),
    ImageCompressionInfo("g25n2c08", 405, 399, 473, 32, 32, 8, 2, 8, 3),
    ImageCompressionInfo("g25n3p04", 215, 215, 226, 32, 32, 4, 3, 4, 3),
    ImageCompressionInfo("oi1n0g16", 167, 152, 645, 32, 32, 16, 0, 16, 0),
    ImageCompressionInfo("oi1n2c16", 302, 274, 2666, 32, 32, 16, 2, 16, 2),
    ImageCompressionInfo("oi2n0g16", 179, 152, 645, 32, 32, 16, 0, 16, 0),
    ImageCompressionInfo("oi2n2c16", 314, 274, 2666, 32, 32, 16, 2, 16, 2),
    ImageCompressionInfo("oi4n0g16", 203, 152, 645, 32, 32, 16, 0, 16, 0),
    ImageCompressionInfo("oi4n2c16", 338, 274, 2666, 32, 32, 16, 2, 16, 2),
    ImageCompressionInfo("oi9n0g16", 1283, 152, 645, 32, 32, 16, 0, 16, 0),
    ImageCompressionInfo("oi9n2c16", 3038, 274, 2666, 32, 32, 16, 2, 16, 2),
    ImageCompressionInfo("pp0n2c16", 962, 934, 3326, 32, 32, 16, 2, 16, 2),
    ImageCompressionInfo("pp0n6a08", 818, 818, 3737, 32, 32, 8, 6, 8, 6),
    ImageCompressionInfo("ps1n0g08", 1477, 132, 730, 32, 32, 8, 0, 8, 0),
    ImageCompressionInfo("ps1n2c16", 1641, 274, 2666, 32, 32, 16, 2, 16, 2),
    ImageCompressionInfo("ps2n0g08", 2341, 132, 730, 32, 32, 8, 0, 8, 0),
    ImageCompressionInfo("ps2n2c16", 2505, 274, 2666, 32, 32, 16, 2, 16, 2),
    ...
    ImageCompressionInfo("s04n3p01", 121, 106, 107, 4, 4, 1, 3, 1, 3),
    ImageCompressionInfo("s05i3p02", 134, 119, 124, 5, 5, 2, 3, 2, 3),
    ImageCompressionInfo("s05n3p02", 129, 114, 114, 5, 5, 2, 3, 2, 3),
    ImageCompressionInfo("s06i3p02", 143, 128, 129, 6, 6, 2, 3, 2, 3),
    ImageCompressionInfo("s06n3p02", 131, 116, 117, 6, 6, 2, 3, 2, 3),
    ImageCompressionInfo("s07i3p02", 149, 134, 137, 7, 7, 2, 3, 2, 3),
    ImageCompressionInfo("s07n3p02", 138, 123, 125, 7, 7, 2, 3, 2, 3),
    ImageCompressionInfo("s08i3p02", 149, 134, 139, 8, 8, 2, 3, 2, 3),
    ImageCompressionInfo("s08n3p02", 139, 124, 124, 8, 8, 2, 3, 2, 3),
    ImageCompressionInfo("s09i3p02", 147, 132, 136, 9, 9, 2, 3, 2, 3),
    ImageCompressionInfo("s09n3p02", 143, 128, 132, 9, 9, 2, 3, 2, 3),
    ImageCompressionInfo("s32i3p04", 355, 340, 346, 32, 32, 4, 3, 4, 3),
    ImageCompressionInfo("s32n3p04", 263, 248, 249, 32, 32, 4, 3, 4, 3),
    ImageCompressionInfo("s33i3p04", 385, 370, 376, 33, 33, 4, 3, 4, 3),
    ImageCompressionInfo("s33n3p04", 329, 314, 317, 33, 33, 4, 3, 4, 3),
    ImageCompressionInfo("s34i3p04", 349, 332, 329, 34, 34, 4, 3, 4, 3),
    ImageCompressionInfo("s34n3p04", 248, 229, 237, 34, 34, 4, 3, 4, 3),
    ImageCompressionInfo("s35i3p04", 399, 384, 391, 35, 35, 4, 3, 4, 3),
    ImageCompressionInfo("s35n3p04", 338, 313, 321, 35, 35, 4, 3, 4, 3),
    ImageCompressionInfo("s36i3p04", 356, 339, 348, 36, 36, 4, 3, 4, 3),
    ImageCompressionInfo("s36n3p04", 258, 240, 247, 36, 36, 4, 3, 4, 3),
    ImageCompressionInfo("s37i3p04", 393, 378, 391, 37, 37, 4, 3, 4, 3),
    ImageCompressionInfo("s37n3p04", 336, 317, 321, 37, 37, 4, 3, 4, 3),
    ImageCompressionInfo("s38i3p04", 357, 339, 343, 38, 38, 4, 3, 4, 3),
    ImageCompressionInfo("s38n3p04", 245, 228, 234, 38, 38, 4, 3, 4, 3),
    ImageCompressionInfo("s39i3p04", 420, 405, 407, 39, 39, 4, 3, 4, 3),
    ImageCompressionInfo("s39n3p04", 352, 336, 341, 39, 39, 4, 3, 4, 3),
    ImageCompressionInfo("s40i3p04", 357, 340, 347, 40, 40, 4, 3, 4, 3),
    ImageCompressionInfo("s40n3p04", 256, 237, 241, 40, 40, 4, 3, 4, 3),
    ImageCompressionInfo("tbbn1g04", 419, 405, 407, 32, 32, 4, 0, 4, 0),
    ImageCompressionInfo("tbbn2c16", 1994, 1095, 1116, 32, 32, 16, 2, 8, 3),
    ImageCompressionInfo("tbbn3p08", 1128, 1095, 1116, 32, 32, 8, 3, 8, 3),
    ImageCompressionInfo("tbgn2c16", 1994, 1095, 1116, 32, 32, 16, 2, 8, 3),
    ImageCompressionInfo("tbgn3p08", 1128, 1095, 1116, 32, 32, 8, 3, 8, 3),
    ImageCompressionInfo("tbrn2c08", 1347, 1095, 1116, 32, 32, 8, 2, 8, 3),
    ImageCompressionInfo("tbwn1g16", 1146, 582, 597, 32, 32, 16, 0, 8, 0),
    ImageCompressionInfo("tbwn3p08", 1131, 1095, 1116, 32, 32, 8, 3, 8, 3),
    ImageCompressionInfo("tbyn3p08", 1131, 1095, 1116, 32, 32, 8, 3, 8, 3),
    ImageCompressionInfo("tp0n1g08", 689, 568, 583, 32, 32, 8, 0, 8, 0),
    ImageCompressionInfo("tp0n2c08", 1311, 1099, 1114, 32, 32, 8, 2, 8, 3),
    ImageCompressionInfo("tp0n3p08", 1120, 1098, 1114, 32, 32, 8, 3, 8, 3),
    ImageCompressionInfo("tp1n3p08", 1115, 1095, 1116, 32, 32, 8, 3, 8, 3),
    ImageCompressionInfo("z00n2c08", 3172, 224, 1957, 32, 32, 8, 2, 8, 2),
    ImageCompressionInfo("z03n2c08", 232, 224, 1957, 32, 32, 8, 2, 8, 2),
    ImageCompressionInfo("z06n2c08", 224, 224, 1957, 32, 32, 8, 2, 8, 2),
    ImageCompressionInfo("z09n2c08", 224, 224, 1957, 32, 32, 8, 2, 8, 2),
};
...
OpaqueImageInfo kOpaqueImagesWithAlpha[] = {{"rgba_opaque", 1, 6, 2},
                                            {"grey_alpha_opaque", 1, 4, 0},
                                            {"bgai4a16", 0, 4, 4}};

void AssertMatch(const GoogleString& in, const GoogleString& ref,
                 PngReaderInterface* reader, const ImageCompressionInfo& info,
                 GoogleString in_rgba) {
  MockMessageHandler message_handler(new NullMutex);
  PngReader png_reader(&message_handler);
  int width, height, bit_depth, color_type;
  GoogleString out;
  EXPECT_EQ(info.original_size, in.size()) << info.filename;
  ASSERT_TRUE(
  ...
  ASSERT_TRUE(
      png_reader.GetAttributes(out, &width, &height, &bit_depth, &color_type))
      << info.filename;
...
class PngOptimizerTest : public testing::Test {
 public:
  PngOptimizerTest() : message_handler_(new NullMutex) {}
...
class PngScanlineReaderRawTest : public testing::Test {
 public:
  PngScanlineReaderRawTest() : message_handler_(new NullMutex) {}
...
class PngScanlineWriterTest : public testing::Test {
 public:
  ...
  bool Initialize() {
    writer_.reset(CreateScanlineWriter(pagespeed::image_compression::IMAGE_PNG,
                                       pixel_format_, width_, height_, &params_,
                                       &output_, &message_handler_));
...
TEST_F(PngOptimizerTest, ValidGifs) {
  ...
  for (size_t i = 0; i < kValidGifImageCount; i++) {
    ...
    ReadTestFile(kPngSuiteGifTestDir, kValidGifImages[i].filename, "gif", &in);
    ReadTestFile(kPngSuiteGifTestDir, kValidGifImages[i].filename, "gif.rgba",
                 &gif_rgba);
...
#else
  ASSERT_DEATH(ScopedPngStruct t = ScopedPngStruct(
                   static_cast<ScopedPngStruct::Type>(-1), &message_handler_),
...
TEST_F(PngScanlineReaderRawTest, ValidPngsEntire) {
  ...
  for (size_t i = 0; i < kValidImageCount; ++i) {
    ...
    ASSERT_TRUE(ReadImage(pagespeed::image_compression::IMAGE_PNG,
                          ...
                          &buffer_for_raw_reader, &pixel_format, &width,
                          nullptr, &bytes_per_row, &message_handler_));
...
TEST_F(PngScanlineReaderRawTest, InvalidPngs) {
  ...
  for (size_t i = 0; i < kInvalidFileCount; i++) {
    ...
    ASSERT_FALSE(ReadImage(pagespeed::image_compression::IMAGE_PNG,
                           image_string.data(), image_string.length(), nullptr,
  ...
  *total_bytes = 0;
  ...
  for (size_t i = 0; i < kValidImageCount; i++) {
    ...
    if (best_compression) {
      ...
      params = std::make_unique<PngCompressParams>(filter_level,
                                                   compression_strategy, false);
    }

    // Initialize the writer.
    writer_.reset(CreateScanlineWriter(
        pagespeed::image_compression::IMAGE_PNG, pixel_format, width, height,
        params.get(), &rewritten_image, &message_handler_));
    ...
    while (original_reader.HasMoreScanLines()) {
      ...
      ASSERT_TRUE(
          writer_->WriteNextScanline(reinterpret_cast<void*>(scanline)));
    }
