...
struct ImageCompressionInfo {
 public:
  ImageCompressionInfo(const char* a_filename, size_t a_original_size,
                       size_t a_compressed_size_best,
                       size_t a_compressed_size_default, int a_width,
                       int a_height, int a_original_bit_depth,
                       int a_original_color_type, int a_compressed_bit_depth,
...
struct GoldImageCompressionInfo : public ImageCompressionInfo {
 public:
  GoldImageCompressionInfo(const char* a_filename, size_t a_original_size,
                           size_t a_compressed_size_best,
                           size_t a_compressed_size_default, int a_width,
                           int a_height, int a_original_bit_depth,
                           int a_original_color_type,
                           int a_compressed_bit_depth,
                           int a_compressed_color_type, bool a_transparency)
      : ImageCompressionInfo(a_filename, a_original_size,
                             a_compressed_size_best, a_compressed_size_default,
                             a_width, a_height, a_original_bit_depth,
                             a_original_color_type, a_compressed_bit_depth,
...
// for the library versions bundled with Envoy.
const GoldImageCompressionInfo kValidGifImages[] = {
    ...
    GoldImageCompressionInfo("basi3p04", 344, 185, 190, 32, 32, 8, 3, 4, 3,
                             false),
    GoldImageCompressionInfo("basi3p08", 1737, 1274, 1904, 32, 32, 8, 3, 8, 3,
                             false),
    ...
    GoldImageCompressionInfo("basn3p04", 344, 185, 190, 32, 32, 8, 3, 4, 3,
                             false),
    GoldImageCompressionInfo("basn3p08", 1737, 1274, 1904, 32, 32, 8, 3, 8, 3,
                             false),
...
bool ReadFile(const GoogleString& file_name, GoogleString* content);

bool ReadTestFile(const GoogleString& path, const char* name,
                  const char* extension, GoogleString* content);
...
void DecodeAndCompareImages(
    ...
    bool ignore_transparent_rgb, MessageHandler* message_handler);

void DecodeAndCompareImagesByPSNR(
    pagespeed::image_compression::ImageFormat image_format1,
    const void* image_buffer1, size_t buffer_length1,
    pagespeed::image_compression::ImageFormat image_format2,
    const void* image_buffer2, size_t buffer_length2, double min_psnr,
    bool ignore_transparent_rgb, bool expand_colors,
...
inline GoogleString PixelRgbaChannelsToString(const uint8_t* const channels) {
  return absl::StrFormat("%02hhx%02hhx%02hhx%02hhx", channels[RGBA_RED],
                         channels[RGBA_GREEN], channels[RGBA_BLUE],
                         channels[RGBA_ALPHA]);
}
